...
/**
 * \file    test/phpunit/ReportsFunctionalTest.php
 * \ingroup reports
 ...
 * @package Testreports
 */
class ReportsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/reports/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('reports/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/reports/admin/about.php');
		$this->authenticate();
		return $this->assertContains('reports/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('reportswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modReports_ReportsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modReports_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
